...
export class EmpresaController {
    ...
    async getAdheridas(
        ...
        const empresas = await this.listarAdheridasUseCase.execute(fromDate, toDate);
    ...
    async getConTransferencias(
        ...
        const empresas = await this.listarConTransferenciasUseCase.execute(fromDate, toDate);
        return empresas.map(e => e.toPrimitives());
    }
