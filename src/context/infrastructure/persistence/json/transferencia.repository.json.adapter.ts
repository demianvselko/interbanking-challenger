...
import { Transferencia } from 'context/domain/core/entities/transfer';
import { MontoVO } from 'context/domain/core/value-objects/transfer/amount';
...
export class TransferenciaJsonRepositoryAdapter extends TransferenciaRepository {
  ...
  constructor() {
    super();
    this.transferencias = transferenciasRaw.map(
      (t) =>
        new Transferencia(
          crypto.randomUUID(),
          t.empresaId,
